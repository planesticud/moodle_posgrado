...
function qtype_vplquestion_evaluate($answer, $question, $deletesubmissions) {
    ...
    $files = array($reqfilename => $answeredreqfile) + qtype_vplquestion_format_execution_files(json_decode($question->execfiles));
    ...
    do {
        ...
        try {
            ...
            curl_setopt($ch, CURLOPT_WRITEFUNCTION, function($chdummy, $data){
            ...
            $result = mod_vpl_edit::retrieve_result($vpl, $userid);
            $retry = false;
